...
public final class Task1Samples {
	...
	public static void main(String[] args) {
		System.out.println("Uebung 5 - Aufgabe 2");
		System.out.println("--------------------");
		System.out.println();

		Task1 stack = new Task1Impl_BenjaminBuetikofer();

		/*
		 * Vor vielen, vielen Jasdasdasd
		 */
		...
		System.out.println("----- Ubsdasdasdsad (fast) alles weg ----");
